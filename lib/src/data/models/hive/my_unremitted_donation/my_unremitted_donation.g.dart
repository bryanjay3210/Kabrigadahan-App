...
part of 'my_unremitted_donation.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class MyUnremittedDonationAdapter extends TypeAdapter<MyUnremittedDonation> {
  @override
  final int typeId = 5;

  @override
  MyUnremittedDonation read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, MyUnremittedDonation obj) {
    writer
      ..writeByte(12)
      ..writeByte(0)
      ..write(obj.caseCode)
  ...
  bool operator ==(Object other) =>
      ...
      other is MyUnremittedDonationAdapter &&
