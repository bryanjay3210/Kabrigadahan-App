...
part of 'members_under_co.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class MembersUnderCOAdapter extends TypeAdapter<MembersUnderCO> {
  @override
  final int typeId = 4;

  @override
  MembersUnderCO read(BinaryReader reader) {
    ...
    return MembersUnderCO(
      ...
      cityQrCodeId: fields[11] as String?,
    );
  }

  @override
  void write(BinaryWriter writer, MembersUnderCO obj) {
    writer
      ..writeByte(12)
      ..writeByte(0)
      ..write(obj.name)
  ...
  bool operator ==(Object other) =>
      ...
      other is MembersUnderCOAdapter &&
