...
part of 'unremitted_donation_ui_server.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class UnremittedDonationUiServerAdapter
    extends TypeAdapter<UnremittedDonationUiServer> {
  @override
  final int typeId = 11;

  @override
  UnremittedDonationUiServer read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, UnremittedDonationUiServer obj) {
    writer
      ..writeByte(12)
      ..writeByte(0)
      ..write(obj.caseCode)
  ...
  bool operator ==(Object other) =>
      ...
      other is UnremittedDonationUiServerAdapter &&
