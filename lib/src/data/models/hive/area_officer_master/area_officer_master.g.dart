...
part of 'area_officer_master.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class AreaOfficerMasterAdapter extends TypeAdapter<AreaOfficerMaster> {
  @override
  final int typeId = 7;

  @override
  AreaOfficerMaster read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, AreaOfficerMaster obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.amount)
  ...
  bool operator ==(Object other) =>
      ...
      other is AreaOfficerMasterAdapter &&
