...
class MasterCollectionSearch extends StatefulWidget {
  final List<dynamic>? remittedDonationList;
  const MasterCollectionSearch({Key? key, required this.remittedDonationList}) : super(key: key);

  @override
  _MasterCollectionSearchState createState() => _MasterCollectionSearchState();
}

class _MasterCollectionSearchState extends State<MasterCollectionSearch> {
  @override
